...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour name must have lesser than or equal to 40 characters'],
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10 //runs each time there is a new value for the ratingsAverage field.
    },
    ratingsQuantity: {
      type: Number,
      default: 0
